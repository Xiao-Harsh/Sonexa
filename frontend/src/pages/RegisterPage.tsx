...
import { Mail, Lock, User, AlertCircle, CheckCircle, Loader2, Eye, EyeOff, ArrowLeft, Disc3, Sparkles } from 'lucide-react';
    ...
    >
      ...
      >
          ...
          <div className="flex flex-col justify-between p-8 lg:p-10 bg-gradient-to-br from-white/[0.05] via-white/[0.02] to-transparent border-r border-white/[0.07] relative overflow-hidden">
            ...
            <div>
              ...
              <h2 className="text-2xl lg:text-3xl font-bold tracking-tight text-white leading-tight">
                Curate your personal sound universe.
              </h2>
              <p className="text-neutral-400 text-sm mt-3 leading-relaxed">
                Join thousands of music lovers streaming high-fidelity audio, creating infinite playlists, and finding new obsessions.
              </p>
            </div>

            {/* Middle: Music Showcase Pill */}
            <div className="my-6 p-4 rounded-2xl bg-white/[0.03] border border-white/[0.06] flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xs font-semibold text-white">Infinite Discovery</div>
                  <div className="text-[11px] text-neutral-400">Zero Audio Ads • Studio Quality</div>
                </div>
              </div>
              <div className="flex items-end gap-1 h-6">
                <span className="w-1 bg-emerald-400 rounded-full animate-pulse" style={{ height: '50%' }} />
                <span className="w-1 bg-emerald-400 rounded-full animate-pulse" style={{ height: '90%', animationDelay: '0.2s' }} />
                <span className="w-1 bg-emerald-400 rounded-full animate-pulse" style={{ height: '35%', animationDelay: '0.4s' }} />
                <span className="w-1 bg-emerald-400 rounded-full animate-pulse" style={{ height: '100%', animationDelay: '0.1s' }} />
                <span className="w-1 bg-emerald-400 rounded-full animate-pulse" style={{ height: '65%', animationDelay: '0.3s' }} />
              </div>
            </div>
            ...
            <div className="space-y-2 text-xs text-neutral-300">
              <div className="flex items-center gap-2">
                ...
                <span>Free high-fidelity audio stream</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-400" />
                <span>Personalized library & playlist creator</span>
              </div>
            </div>
          </div>
        )}
        ...
        {isShortLandscape && (
          <div className="flex flex-col items-start text-left pr-2">
            ...
            <div className="mt-3 flex items-center gap-2 text-[11px] text-neutral-400 font-medium">
              ...
              <span>Unlimited high-fidelity streaming</span>
            </div>
          </div>
        )}
        ...
        <div className={isWideScreen ? 'p-8 lg:p-10 flex flex-col justify-center' : ''}>
          ...
          {/* Footer actions */}
          <div className={`mt-3 sm:mt-4 ${isShortLandscape ? 'text-left' : isWideScreen ? 'text-left' : 'text-center'}`}>
